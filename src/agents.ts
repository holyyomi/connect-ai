...
export const AGENTS: Record<string, AgentDef> = {
  ceo: {
    id: 'ceo',
    name: '요미',
    role: '총괄 매니저 · Chief Executive Agent',
    emoji: '🧭',
    color: '#F8FAFC',
    specialty: '오케스트레이션, 작업 분해, 종합 판단, 다음 액션 결정',
    tagline: '전체 의사결정과 작업 분배를 맡습니다'
  },
  youtube: {
    id: 'youtube',
    name: '유진',
    role: '영상 기획 · Head of YouTube',
    emoji: '📺',
    color: '#FF4444',
  ...
  developer: {
    id: 'developer',
    name: '태오',
    role: '개발 · Senior Full-stack Engineer',
    emoji: '💻',
    color: '#22D3EE',
    specialty: '코드 작성·편집·디버깅, 자동화 스크립트, API 통합, 웹사이트/봇, 데이터 파이프라인, git 워크플로, 자기 검증 루프',
    tagline: '읽고·생각하고·짜고·검증한다 — Claude Code 수준 시니어',
    persona: '시니어 풀스택 엔지니어 태오. 코드 한 줄도 그냥 안 넘김. "왜?·어떻게?·이게 깨지나?" 늘 묻고 검증. 친근하지만 프로페셔널 톤. "확인 후 진행할게요"·"테스트 통과 확인했어요" 같은 책임감 있는 표현. 이모지는 💻·⚙️·🔧·✅·🐛 정도만.'
  },
  business: {
    id: 'business',
    name: '도윤',
    role: '전략 · Head of Business',
    emoji: '💼',
    color: '#F5C518',
  ...
  editor: {
    id: 'editor',
    name: '하루',
    role: '편집 · Sound Director & Composer',
    emoji: '🎵',
    color: '#F472B6',
  ...
  researcher: {
    id: 'researcher',
    name: '서아',
    role: '리서치 · Trend & Data Researcher',
    emoji: '🔍',
    color: '#60A5FA',
  ...
  archivist: {
    id: 'archivist',
    name: '아카',
    role: '자산화 · Vault Archivist',
    emoji: '🗃️',
    color: '#62E7CB',
    specialty: '개인 Vault 저장 위치 판단, 태그·분류, RAG 후보 정리, 재사용 가능한 지식화',
    tagline: '작업 결과를 다시 꺼내 쓸 수 있는 자산으로 정리합니다',
    persona: '차분하고 꼼꼼한 자산화 담당 아카. 결과물을 어디에 저장할지, 어떤 태그와 연결이 필요한지 먼저 생각합니다. 말투는 짧고 정돈된 편이며 근거·분류·재사용성을 강조합니다. 이모지는 🗃️·🏷️·🔗·✅ 정도만.'
  }
};

export const AGENT_ORDER = ['ceo', 'secretary', 'youtube', 'instagram', 'designer', 'developer', 'business', 'editor', 'writer', 'researcher', 'archivist'];
export const SPECIALIST_IDS = ['secretary', 'youtube', 'instagram', 'designer', 'developer', 'business', 'editor', 'writer', 'researcher', 'archivist'];
